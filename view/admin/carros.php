...
<div class="content-management">
    ...
    <div class="table-container">
        <table class="data-table">
            ...
            <tbody>
                <?php if (empty($carros)): ?>
                    <tr><td colspan="8" class="no-results">Nenhum carro encontrado.</td></tr>
                <?php else: ?>
                    <?php foreach ($carros as $carro): ?>
                        <tr>
                            ...
                            <td>
                                <span class="badge badge-<?= strtolower($carro['status']) ?>">
...
<div class="modal fade" id="createCarModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-lg"><div class="modal-content">
    ...
    <form action="controller/CarroControl.php" method="POST" class="form-loading-feedback">
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="number" class="form-control" name="preco_diaria" step="0.01" inputmode="decimal" autocomplete="off" onwheel="this.blur()" required>
          </div>
          ...
          <div class="col-md-6 mb-3">
            ...
            <select name="categoria" id="novo-categoria" class="form-select" required>
              ...
              <?php foreach (CATEGORIAS_CARRO as $valor => $label): ?>
                  <?php if ($valor === 'NaoClassificado') continue; ?>
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="number" class="form-control" name="km_total" min="0" step="1" value="0">
          </div>

          <div class="col-md-6 mb-3">
            <label class="form-label d-block">Ar-condicionado</label>
            <div class="form-check">
              <input class="form-check-input" type="checkbox" id="novo-ar" name="ar_condicionado" checked>
              <label class="form-check-label" for="novo-ar">Possui ar-condicionado</label>
            </div>
          </div>

          <div class="col-12 mb-3">
            <label class="form-label">Descrição</label>
            <textarea class="form-control" name="descricao" rows="2" placeholder="Opcional"></textarea>
          </div>
        </div>
      </div>
...
<div class="modal fade" id="editCarModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-lg"><div class="modal-content">
    ...
    <form id="editCarForm" action="controller/CarroControl.php" method="POST" class="form-loading-feedback">
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            <label class="form-label">Cor</label>
            <input type="text" class="form-control" id="edit-cor" name="cor" required>
          </div>

          <div class="col-md-6 mb-3">
            <label class="form-label">Preço da Diária</label>
            <input type="number" class="form-control" id="edit-preco" name="preco_diaria" step="0.01" inputmode="decimal" onwheel="this.blur()" autocomplete="off" required>
          </div>
          ...
          <div class="col-md-6 mb-3">
            <label class="form-label">Combustível</label>
            <select id="edit-combustivel" name="combustivel" class="form-select" required>
              <option value="gasolina">Gasolina</option>
              <option value="alcool">Álcool</option>
              <option value="flex">Flex</option>
              <option value="diesel">Diesel</option>
          ...
          <div class="col-md-6 mb-3">
            <label class="form-label">Câmbio</label>
            <select id="edit-cambio" name="cambio" class="form-select" required>
              <option value="manual">Manual</option>
              <option value="automatico">Automático</option>
            </select>
          </div>
          ...
          <div class="col-md-6 mb-3">
            <label class="form-label">KM Total</label>
            <input type="number" class="form-control" id="edit-km" name="km_total" min="0" step="1" value="0">
          </div>
          <div class="col-md-6 mb-3">
            <label class="form-label d-block">Ar-condicionado</label>
            <div class="form-check">
              <input class="form-check-input" type="checkbox" id="edit-ar" name="ar_condicionado">
              <label class="form-check-label" for="edit-ar">Possui ar-condicionado</label>
            </div>
          </div>

          <div class="col-12 mb-3">
            <label class="form-label">Descrição</label>
            <textarea class="form-control" id="edit-descricao" name="descricao" rows="2" placeholder="Opcional"></textarea>
          </div>
        </div>
      </div>
